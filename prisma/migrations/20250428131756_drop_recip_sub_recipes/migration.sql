/*
  ...
  - You are about to drop the `recipe_sub_recipes` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the column `isPreferment` on the `recipes` table. All the data in the column will be lost.

*/
-- DropTable
PRAGMA foreign_keys=off;
DROP TABLE "recipe_sub_recipes";
