...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="text-[16px] sm:text-[20px]">
      <body className={`${inter.className} antialiased text-slate-500 bg-white`}>
        <div className={`w-[min(100%-3rem,_90ch)] mx-auto`}>
          <div className="relative pt-6 lg:pt-8 flex items-center justify-between text-slate-700 font-semibold text-sm leading-6">
            <svg className="text-slate-900 w-auto h-7" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              <g>
                <path className="st0" fill="currentColor" d="M436.948,75.059C388.559,26.657,324.311,0,255.98,0c-68.276,0-132.532,26.657-180.92,75.059
                ...
                <path className="st0" fill="currentColor" d="M256.007,69.53c-102.984,0-186.47,83.486-186.47,186.47s83.486,186.47,186.47,186.47
